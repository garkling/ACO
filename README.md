...
Модуль призначений для візуалізації мурашиного шляху на випадково-згенерованому повному графі. 
Алгоритм:
    ...
    Малюванння відбувєаться завряди бібліотеці `pygame`, яка надає високорівнений інтерфейс екрану для малювання, а також методи оновлення екрану
